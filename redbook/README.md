...
基于人工智能本身和人工智能通识教育快速发展的现实，本红皮书采用开放编辑策略，欢迎人工智能专家、教育专家、社会学者参与，包括但不限于：（1）意见与建议; （2）新增主题
讨论；（3）相关理论与实践探索。红皮书将吸收专家意见进行版本升级，并通过书中附件“AIGE Contributors”标记参与者的贡献。

讨论提交途径：（1）Github讨论区 http://github.com/thuaige/aige-public; (2) 邮件：aigraph@cslt.org


## 相关资源

1. 清华AIGE中心主页： http://thuaige.org
2. Zenodo AIGE社区： https://zenodo.org/communities/aige/


## 许可协议

除另有说明外，《人工智能通识教育：智能社会中的认知自治》及本仓库中与本书相关的原创内容，采用[知识共享署名—非商业性使用—禁止演绎 4.0 国际许可协议（CC BY-NC-ND 4.0）](https://creativecommons.org/licenses/by-nc-nd/4.0/deed.zh-hans)发布。

您可以在完整保留作品内容、注明书名与作者、提供许可协议链接且不用于商业目的的前提下，复制和传播本作品。

未经著作权人书面许可，不得公开传播经过修改、删节、改写、重组或翻译形成的版本，也不得将本作品用于商业出版、付费课程、商业平台资源包及其他以商业利益或金钱报酬为主要目的的活动。

建议署名方式：

> 王东、马少平：《人工智能通识教育：智能社会中的认知自治》，清华大学计算机系人工智能通识教育研究中心（AIGE），2026年。
